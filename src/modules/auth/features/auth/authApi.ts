...
// GET TOKEN
export const fetchAuthentication = createAsyncThunk("auth/fetchAuthentication", async (form, thunkApi) => {
    try {
...
// GET REFRESH TOKEN
export const fetchRefreshToken = createAsyncThunk("auth/refresh-token", async () => {
    try {
